...
import com.inventory.controller.InventoryAuthenticationService;
...
class InventoryControllerTest {
		...
		@MockBean
		private InventoryAuthenticationService authService;
		...
		public void addInventoryControllerTest() throws InventoryNotFoundException {
			...
			when(inventoryService.addInventory(i)).thenReturn(i);
			when(authService.isSessionValid("token")).thenReturn(true);
		...
		public void updateInventoryControllerTest() throws InventoryNotFoundException {
			...
			when(inventoryService.updateInventory(i)).thenReturn(i);
			when(authService.isSessionValid("token")).thenReturn(true);
		...
		public void deleteInventoryControllerTest() throws InventoryNotFoundException {
			...
			when(inventoryService.deleteInventory(1)).thenReturn("Deleted Successfully");
			when(authService.isSessionValid("token")).thenReturn(true);
