...
import com.roomservice.controller.RoomAuthenticationService;
...
class RoomControllerTest {
	...
	@MockBean
	private RoomAuthenticationService authService;
	...
	public void ShowRoomByIdControllerTest() throws RoomNotFoundException {
		...
		when(authService.isSessionValid("token")).thenReturn(true);
		assertEquals(r, controller.showRoomById(1, token).getBody());
	}
